...
describe('api/genres', () => { 
    ...
    describe('GET /:id', () =>{
        ...
        it('should return a 404 if not genre with the given id is not found', async()=>{
    ...
    describe('POST /', ()=>{
        ...
        // we define a happy path and then in each test we
        ...
        it('should return 400 if genre is less than 5', async()=>{
